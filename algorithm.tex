...
machine. Duplicte data that went to more than one bottom tree will need to 
sort their list of values based on distances and return the K closests points.
...
\hspace{29pt} $\frac{1}{M} = $ our sampleing probability.}
