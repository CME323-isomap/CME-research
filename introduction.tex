...
relaying information learned from 
\textbf{MENTION GOOGLE CITATION}, where they talk about the use of implementing 
an approximate K nearest neighbor search in a distributed enviornment using 
hybrid spill trees.
\textbf{ADD CITATION???} 
